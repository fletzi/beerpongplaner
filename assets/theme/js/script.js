...
$jscomp.polyfill("Array.from", function (b) {
    return b ? b : function (b, c, q) {
        ...
        var f = [], p = "undefined" != typeof Symbol && Symbol.iterator && b[Symbol.iterator];
...
(function () {
    ...
    function G(a) {
        var b = "", d = a.querySelector("svg linearGradient");
        if (d) {
            b = [];
    ...
    function z(a, b, d) {
        var g = a.closest(".card"), h = g.parentElement.classList;
    ...
    function D(a) {
        var b = a.closest("section").getAttribute("id") + "-svg-gradient", d = +a.getAttribute("data-goal");
        z(a, b, d)
    }
    ...
    function H(a, b) {
        if (a.classList.contains("circle-progress-section") && b.includes("progress") && "progressCount" != b) if (b.includes("Color")) a.querySelectorAll(".pie_progress").forEach(function (b) {
            var d = a.getAttribute("id") + "-svg-gradient", g = +b.getAttribute("data-goal");
            z(b, d, g)
        }); else {
    ...
    Element.prototype.footerReveal = function () {
        ...
        var b = this.previousElementSibling, d = !!document.documentMode;
        a();
    ...
    var I = function () {
        ...
        b.appendChild(a);
        var d = parseInt(window.innerHeight / 2, 10), c = parseInt((window.getComputedStyle ?
    ...
    l(function () {
        ...
        function d(a) {
            b(a, "[data-bg-video]").forEach(function (a) {
                ...
                if (b) {
                    ...
                    if (d && (/youtu\.?be/g.test(d[3]) || /vimeo/g.test(d[3]))) if (d && /youtu\.?be/g.test(d[3])) {
                        ...
                        h.onload = function () {
                            ...
                            var m = document.createElement("div"), g = document.createElement("div"),
                            ...
                            var e = h.naturalHeight, x = h.naturalWidth, f = h.naturalHeight / h.naturalWidth,
                                E = b.parentNode.clientHeight, r = b.parentNode.clientWidth;
                            e = e < E ? e : E;
                            x = x > r ? x : r;
                            e / x != f && (e = x * f);
        ...
        document.querySelectorAll(".cols-same-height .mbr-figure").forEach(function (a) {
            ...
            var d = a.querySelector("img"), h = a.parentNode, g = d.width, k = d.height;
    ...
    l(function () {
        if (!n) {
            ...
            document.querySelectorAll(".modalWindow-video > iframe").forEach(function (a) {
                ...
                var d = b.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/);
                -1 !== b.indexOf("youtu") ? a.setAttribute("src", "https://youtube.com/embed/" + d[6] +
    ...
    0 != document.body.querySelectorAll("section.popup-btn-cards").length && (window.initPopupBtnPlugin = !0, document.querySelectorAll("section.popup-btn-cards .card-wrapper").forEach(function (a) {
        ...
        y(a)
    })), "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin =
        !0, l(function () {
...
!function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.in">Mobirise</a> Mobirise v5.6.0';
